...
class Config():
    ...
    MESSAGR_DIR = {
        ...
        f'{M_PREFIX}胡爾芳' : ['好啦你很好看',"我最喜歡朴燦烈🥳"],
        f'{M_PREFIX}557' : ['你們都一樣!!!😭😭'],
        f'{M_PREFIX}小橘子' : ['你很好你真的特別好😩😩'],
        f'{M_PREFIX}蘇佑昕' :["沒關係ㄚ 反正我就不是那麼重要的人 我就可有可無ㄚ\n還是我去死 算了 我去死好了 你根本不在意⋯\n數到3我就要跳了\n1\n2\n4\n忘記數到3了😅\n算了 下次再跳",'你的感覺我哪次沒考慮過 但你的偏激真的有點噁==','我就爛我就機掰我就婊子我就幹你娘'],
        f'{M_PREFIX}lyz' : ['閉嘴胡爾芳'],
        f'{M_PREFIX}沈均諺' : ['你這次😡😡真的惹到我了🤜🤜(張子傑)'],
        f'{M_PREFIX}張子傑' : ['這場我沒10殺以後不玩煞蜜拉','阿本來就是你的問題你先檢討自己好不好啊',"下一隻就是不玩路西恩了"],
        f'{M_PREFIX}游小七' : ['我來解夢摟🧐','看你是先被鬼上還是先被我上啦 ^^'],
        f'{M_PREFIX}阿蝶' : ['阿阿阿阿阿阿阿阿阿阿阿阿阿阿阿阿阿阿阿😭😭😭😭😭\n救救命🥺🥺🥺🥺🥺'],
        f'{M_PREFIX}高好文':['我真的該減肥了🍔🍔']
